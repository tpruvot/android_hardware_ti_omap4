 ...
 *          Tesla
 */
#define RCM_MULTICLIENT_DSP_IMAGE        \
                                "./RCMSrvMultiClnt_Dsp_Test.xe64T"
...
Int ipcSetup (Int testCase)
{
    ...
    if (testCase == 1)
        ...
        imageName = RCM_MULTICLIENT_DSP_IMAGE;
...
Void printUsage (Void)
{
    ...
    Osal_printf ("\t./rcm_multiclienttest.out 3 : MPU <--> Tesla Sample\n");
