...
void set_motorola_audio_routing()
{
	...
	error_code = snd_ctl_open(&ctl, "default", 0);
	if(error_code < 0) {
		FMAPP_ERROR("Control \'%s\' open error [error code %d]",
				"default", error_code);
	}
	snd_ctl_elem_value_alloca(&value);
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "LDSPREXT Switch");
	snd_ctl_elem_value_set_boolean(value, 0, 1);
	snd_ctl_elem_write(ctl, value);
	snd_ctl_elem_value_alloca(&value);
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "LDSPLEXT Switch");
	snd_ctl_elem_value_set_boolean(value, 0, 1);
	snd_ctl_elem_write(ctl, value);
	snd_ctl_elem_value_alloca(&value);
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "CPCAP Mixer External PGA");
	snd_ctl_elem_value_set_boolean(value, 0, 1);
	snd_ctl_elem_write(ctl, value);
	snd_ctl_elem_value_alloca(&value);
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "Ext Volume");
	snd_ctl_elem_value_set_integer(value, 0, 0x0C);
	snd_ctl_elem_write(ctl, value);
	snd_ctl_close(ctl);
}
...
void unset_motorola_audio_routing()
{
	...
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "Ext Volume");
	snd_ctl_elem_value_set_integer(value, 0, 0x00);
	snd_ctl_elem_write(ctl, value);
	snd_ctl_elem_value_alloca(&value);
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "CPCAP Mixer External PGA");
	snd_ctl_elem_value_set_boolean(value, 0, 0);
	snd_ctl_elem_write(ctl, value);
	snd_ctl_elem_value_alloca(&value);
	snd_ctl_elem_value_set_interface(value, SND_CTL_ELEM_IFACE_MIXER);
	snd_ctl_elem_value_set_name(value, "LDSPLEXT Switch");
...
#ifdef DEBUG
	MCP_HAL_LOG_Init();
	MCP_HAL_LOG_EnableLogToAndroid("FM_stack");
#endif
