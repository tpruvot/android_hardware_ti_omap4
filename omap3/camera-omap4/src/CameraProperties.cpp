...
const char CameraProperties::SUPPORTED_MOT_HDR_MODES[] = "prop-mot-hdr-mode-values";
...
const char CameraProperties::MOT_HDR_MODE[] = "prop-mot-hdr-mode-default";
...
const char CameraProperties::VNF_VALUES[] = "prop-vnf-values";
...
CameraProperties::CameraPropertyIndex CameraProperties::getCameraPropertyIndex(const char* propName)
{
    ...
    else if(!strcmp(propName,CameraProperties::SUPPORTED_MOT_HDR_MODES))
        {
        CAMHAL_LOGVA("Returning PROP_INDEX_SUPPORTED_MOT_HDR_MODES");
        LOG_FUNCTION_NAME_EXIT
        return CameraProperties::PROP_INDEX_SUPPORTED_MOT_HDR_MODES;
        }
    ...
    else if(!strcmp(propName,CameraProperties::MOT_HDR_MODE))
        {
        CAMHAL_LOGDA("Returning MOT_HDR_MODE");
        LOG_FUNCTION_NAME_EXIT
        return CameraProperties::PROP_INDEX_MOT_HDR_MODE;
        }
    ...
    else if(!strcmp(propName,CameraProperties::VNF))
      {
        CAMHAL_LOGDA("Returning VNF");
        LOG_FUNCTION_NAME_EXIT
          return CameraProperties::PROP_INDEX_VNF;
      }
    else if(!strcmp(propName,CameraProperties::VNF_VALUES))
      {
        CAMHAL_LOGDA("Returning VNF_VALUES");
        LOG_FUNCTION_NAME_EXIT
          return CameraProperties::PROP_INDEX_VNF_VALUES;
      }
...
const char* CameraProperties::getCameraPropertyKey(CameraProperties::CameraPropertyIndex index)
{
    ...
    switch(index)
        ...
        case CameraProperties::PROP_INDEX_SUPPORTED_MOT_HDR_MODES:
            CAMHAL_LOGVB("Returning key: %s ",CameraProperties::SUPPORTED_MOT_HDR_MODES );
            LOG_FUNCTION_NAME_EXIT
            return CameraProperties::SUPPORTED_MOT_HDR_MODES;
        ...
        case CameraProperties::PROP_INDEX_MOT_HDR_MODE:
            CAMHAL_LOGVB("Returning key: %s ",CameraProperties::MOT_HDR_MODE);
            LOG_FUNCTION_NAME_EXIT
            return CameraProperties::MOT_HDR_MODE;
        ...
        case CameraProperties::PROP_INDEX_VNF:
          CAMHAL_LOGVB("Returning key: %s ",CameraProperties::VNF );
            LOG_FUNCTION_NAME_EXIT
              return CameraProperties::VNF;

        case CameraProperties::PROP_INDEX_VNF_VALUES:
          CAMHAL_LOGVB("Returning key: %s ",CameraProperties::VNF_VALUES );
            LOG_FUNCTION_NAME_EXIT
              return CameraProperties::VNF_VALUES;
